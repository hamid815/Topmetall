    ...
    ru: {
      translation: {
        ...
        okompani: {
          ...
          about:
            "Многопрофильное производственное предприятие - основанов 2020 году, как предприятие, специализирующееся на производстве теплообменного, ёмкостного, колонного и нестандартного оборудования",
          points: {
...
кадров`,
        ...
        universal: {
          ...
          seksIavo: {
            title: "Секционные аппараты высокого и низкого давления",
            items: [
              {
                id: 1,
                date: "03.05.2024",
        ...
        info: {
          sidebar: {
            ...
            separatori: "Газожидкостные сепараторы",
          ...
          separatori: {
            title: "Газожидкостные сепараторы",
            alt1: "Сепаратор 1",
            alt2: "Сепаратор 2",
            description:
    ...
    en: {
      translation: {
        ...
        okompani: {
          ...
          about:
            "A multidisciplinary manufacturing company founded in 2020, specializing in the production of heat exchange, tank, column, and non-standard equipment",
          points: {
...
with qualified personnel.`,
        ...
        universal: {
          ...
          seksIavo: {
            title: "Sectional units of high and low pressure",
            items: [
              {
                id: 1,
                date: "03.05.2024",
        ...
        info: {
          sidebar: {
            ...
            separatori: "Gas-liquid separators",
